...
def can_be_created_with_a_hash_of_attributes
  ...
  movie = Movie.create(attributes) #create saves it also.
...
def can_find_the_first_item_from_the_database_using_id
  Movie.find_by(id:1) #retrieving the id should follow the key syntax, must have ()
end
...
def can_be_found_updated_and_saved
  ...
  movie = Movie.find_by(title: "Awesome Flick") #search for the attribute
  movie.update(title: "Even Awesomer Flick") #update
  movie.save #save
end
